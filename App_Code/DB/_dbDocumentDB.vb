...
Namespace SIS.DB
  ...
  Public Class Transmittal_Information
    ...
    Public Property TransDocRev As String = ""
    Public Property TransType As String = ""
    Public Property TransSubject As String = ""
    Public Property TransUser As String = ""
    Public Property TransStat As String = ""
    Public Property TransiDate As String = ""


    Public Shared Function GetTRANSDATA(ByVal DocumentID As String) As List(Of SIS.DB.Transmittal_Information)
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
        ...
        Sql &= "       end) as t_type,bb.t_subj,bb.t_user,(case bb.t_stat "
        ...
        Sql &= "          end) as t_stat, bb.t_isdt from tdmisg132200 as aa "
        Sql &= " inner join tdmisg131200 as bb"
        Sql &= " on aa.t_tran=bb.t_tran"
        Sql &= " where aa.t_docn=('" & DocumentID & "')"
